    ...
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="mb-12">
            <div class="relative max-w-md mx-auto">
                <svg class="w-64 h-48 mx-auto text-gray-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <a href="{{ route('blog.index') }}" class="text-blue-600 hover:text-blue-800 font-medium text-sm">
                    Ver noticias →
                </a>
            </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                ...
                <a href="{{ route('blog.index') }}" class="text-green-600 hover:text-green-800 font-medium text-sm">
                    Explorar →
                </a>
            </div>
