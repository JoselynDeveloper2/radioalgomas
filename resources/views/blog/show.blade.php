...
@section('canonical_url', $article->canonical_url ?: route('blog.show', $article->slug))
...
@section('twitter_title', $article->og_title ?: $article->title)
@section('twitter_description', $article->og_description ?: $article->excerpt)
