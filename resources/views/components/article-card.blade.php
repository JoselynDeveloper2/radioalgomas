    ...
    <div class="p-4 {{ $layout === 'featured' ? 'p-6' : '' }} {{ $layout === 'compact' ? 'flex-1' : '' }}">
        ...
        <h3 class="{{ $titleClasses }} font-bold text-gray-900 dark:text-white mb-3 leading-tight">
            <a href="{{ route('blog.show', $article->slug) }}" 
               class="hover:text-tucanaltv-blue transition-colors group-hover:text-tucanaltv-blue {{ $layout === 'minimal' ? 'line-clamp-2' : '' }}">
                {{ $article->title }}
            </a>
        </h3>
        ...
        <div class="flex items-center justify-between {{ $layout === 'minimal' ? 'mt-2' : 'pt-4 border-t border-gray-100 dark:border-gray-700' }}">
            ...
            <div class="flex items-center">
                <div class="w-{{ $layout === 'minimal' ? '6' : '8' }} h-{{ $layout === 'minimal' ? '6' : '8' }} bg-gradient-to-br from-tucanaltv-blue to-tucanaltv-blue-dark rounded-full flex items-center justify-center mr-3">
